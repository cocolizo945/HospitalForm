          ...
          <div class="tab-pane show active" id="form1">
            ...
            <div class="row" id="datosPacienteRow4">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="entidad_pais" name="entidad_pais" placeholder="Chiapas" minlength="3" required>
                </div>
              </div>
            </div>

            <div class="row" id="datosPacienteRow5">
              <!-- Municipio o alcaldía -->
              <div class="col-md-4">
                <label for="municipio">Municipio o alcaldía:</label>
                <div class="form-group">
                  <input type="text" class="form-control" id="municipio" name="municipio" placeholder="Tapachula" minlength="3" required>
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="localidad" name="localidad" placeholder="Zona Centro" minlength="3" required>
                </div>
              </div>
