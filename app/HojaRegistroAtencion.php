...
class HojaRegistroAtencion extends Model
{
    ...
    protected $fillable = [
        ...
        'unidad_medica', 'fecha_ocurrencia', 'hora_ocurrencia', 'festivo', 'sitio_ocurrencia', 'otro_lugar', 'entidad_pais', 'municipio',
        ...
        'efectos_agresor', 'evento_autoinfligido', 'fecha_atencion', 'hora_atencion', 'servicio_atencion', 'tipo_atencion', 'area_gravedad',
